...
func (r payslip) UpdatePayslip(ctx context.Context, payslipID string, input presentations.PayslipUpdate, opts ...repooption.TxOption) error {
	...
	values := []interface{}{
		payslipID,
		input.BaseSalary,
		input.ProratedSalary,
		input.OvertimePay,
		input.ReimbursementTotal,
		input.TakeHomePay,
		time.Now().Local(),
		input.UpdatedBy,
	}
