...
func (r employee) GetAllEmployee(ctx context.Context, meta *common.Metadata) ([]entity.Employee, error) {
...
`
	...
	err = r.db.Query(ctx, &employees, query, params.Limit, params.Offset, params.DateFrom, params.DateEnd)
	if err != nil {
