...
func (r attendance) GetAllAttendance(ctx context.Context, meta *common.Metadata) ([]entity.Attendance, error) {
...
`
	...
	err = r.db.Query(ctx, &attendances, query, params.Limit, params.Offset, params.DateFrom, params.DateEnd)
	if err != nil {
		return nil, errors.Wrap(err, "failed to get all attendances from database")
	}
