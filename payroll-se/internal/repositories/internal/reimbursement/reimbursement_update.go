...
func (r reimbursement) UpdateReimbursement(ctx context.Context, reimbursementID string, input presentations.ReimbursementUpdate, opts ...repooption.TxOption) error {
